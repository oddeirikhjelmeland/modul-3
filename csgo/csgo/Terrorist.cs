...
namespace csgo
{
    internal class Terrorist
    {
        ...
        {
            if (Shared.IsSuccessful(10) == true && Terrorist.MembersAlive >0)
            {
                FoundASite = true;
        ...
        {
            if (Shared.IsSuccessful(7) == true && CounterTerrorist.MembersAlive > 0 && Terrorist.MembersAlive >0)
            {
        ...
        public void TickingBomb()
        {
            if (BombIsActive)
            {
                ...
                {
                    Shared.counter--;
                    Console.WriteLine("Bomb is ticking: " + Shared.counter);
                }else
                {
